export const lang = {
  ru: {
    ...
    LAYOUT: {
      NOTICE_TEXT: 'Если у Вас есть вопросы ко мне - напишите.',
      PAY_BUTTON: 'Пивко',
      NOTICE_BUTTON: 'Написать',
      COMMENT_TITLE: 'Комментарии'
    },
    SEARCH: {
      ONLY_SEARCH: 'Только тэги',
      PLACEHOLDER: 'Искать',
    ...
    HERO: {
      ...
      NEWSLETTER: {
        SUBSCRIPTION_HEAD: 'Посты на других платформах',
    ...
    CONTACT: {
      ...
      TG_DESCRIPTION: 'Если у Вас есть вопросы, Вы можете связаться со мной в Telegram: ',
    ...
    ERROR: {
      ...
      HELP_TEXT: 'Попробуйте обновить страничку.',
      BACK_TO_HOME: 'Вернуться на главную',
      CRAFTDOCS_ERROR: 'Пу-пу-пу...',
      LOADING: 'Загрузка...',
      TIMEOUT_TEXT: 'Долгая загрузка? Нажмите, чтобы открыть статью в Notion.'
    }
  },
  en: {
    NAV: {
